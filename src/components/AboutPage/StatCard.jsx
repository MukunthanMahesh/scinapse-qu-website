...
export default function StatCard({ value, label, icon: IconComponent, suffix = "+" }) {
  ...
  return (
    ...
    >
      ...
      {IconComponent && (
        <IconComponent className="absolute top-4 right-4 text-5xl text-brand-cyanBlue transition-transform duration-500 group-hover:text-brand-cyanBlue/90 group-hover:rotate-12" />
      )}
